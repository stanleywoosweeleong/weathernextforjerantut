// ============================================================
// WeatherNext Service Worker — Jerantut (Pahang)
...
// storm-confidence wording, AI-greeting crop-owner fix, REAL model-run
// freshness header, AI prompt with per-farm coordinates (keeps Jerantut name).
// Boot screen sky-blue (#8dcdf3) to match the orchard/blue-sky icon art.
// Identity: namespace weathernextforjerantut, appId
// wnext-ag-v41-weathernextforjerantut, name CR, 3 seed farms (Simpang Tebing
...
// with the refined Raub version. Jerantut identity is UNCHANGED —
// weathernextforjerantut namespace, appId wnext-ag-v41-weathernextforjerantut,
// name CR, 3 seed farms (Simpang Tebing Tinggi / Damak / Bukit Seladang), seed
// version jt-arch1, and the build's GPS sort are all preserved exactly. Only the
// broadcast text logic was swapped (function body verified against the pre-fix
// baseline with no Jerantut-specific drift before transplant). Fixes carried:
...
const CACHE_VERSION = 'wnext-weathernextforjerantut-202606052230';
